...
<html>
    ...
    <body>
        ...
        <div id="show-entidade" class="content scaffold-show" role="main">
            ...
            <f:display bean="entidade" />
            <g:form resource="${this.entidade}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.entidade}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

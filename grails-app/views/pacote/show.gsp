    ...
    <body>
        ...
        <div id="show-pacote" class="content scaffold-show" role="main">
            ...
            <div class="message" role="status">${flash.message}</div>
                ...
                <f:display bean="pacote" />
            <g:form resource="${this.pacote}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.pacote}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

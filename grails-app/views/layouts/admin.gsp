...
<div id="app" class="app app-header-fixed app-sidebar-fixed app-footer-fixed">
    <!-- BEGIN #header -->
                ...
                <ul class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0 pb-0">
                    ...
                    <li class="dropdown-message">
                        <a href="#">
                            ...
                            %{--<div class="icon"><div class="img" style="background-image: url(../assets/images/user-2.jpg)"></div></div>--}%
                            <div class="info">
    ...
    <div id="footer" class="app-footer">
        &copy; 2019 seanTheme All Right Reserved
    </div>
    <!-- END #content -->
